...
FFT_Processor_nayuki_FFNT::FFT_Processor_nayuki_FFNT(const int32_t N): _2N(2*N),N(N),Ns2(N/2) {
...
void FFT_Processor_nayuki_FFNT::execute_reverse_int(cplx* res, const int32_t* a) {
...
void FFT_Processor_nayuki_FFNT::execute_reverse_torus32(cplx* res, const Torus32* a) {
...
void FFT_Processor_nayuki_FFNT::execute_direct_torus32(Torus32* res, const cplx* a) {
